		...
		app.SmartActions = function(){
			...
			var smartActions = {
			    ...
			    userLogout: function($this){
					// ask verification
					$.SmartMessageBox({
						title : "<i class='fa fa-sign-out txt-color-orangeDark'></i>" +  ($this.data('logout-title-msg') || "Are you sure want to Logout") + "<span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> ?",
						content : $this.data('logout-msg') || "You can improve your security further after logging out by closing this opened browser",
						buttons : '[' + ($this.data('logout-cmd-no') || "No") + '][' + ($this.data('logout-cmd-yes') || "Yes") + ']'
					}, 
                                        function(ButtonPressed) {
                                            if (ButtonPressed == $this.data('logout-cmd-yes')) {
 ...
 */
	if ($.navAsAjax || $(".google_maps")){
		...
		window.loadGoogleMaps = function() {
			...
			script_tag.setAttribute("src", "http://maps.google.com/maps/api/js?key=AIzaSyC0NoZKKGtq3BFYkID9L_-MqDn8LIV2qHc&sensor=false&callback=gMapsCallback");
