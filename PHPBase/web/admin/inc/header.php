...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
    ...
    <head>
        ...
        <title> <?php echo $page_title != "" ? $page_title." - " : ""; ?><?php echo getLocaleText('APP_NAME', TXT_A); ?> </title>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="<?php echo ASSETS_URL; ?>/css/generic.css">
    ...
    <body <?php echo implode(' ', array_map(function($prop, $value) {
            ...
            ?>
                    ...
                    <header id="header">
                        ...
                        <div id="apptitle" class="col-sm-4" style="//margin-left: 20px;">
                            <span><h1 style="color: #1f629d;font-weight: 500;text-shadow: 1px 1px 1px #687784;"><?php echo getLocaleText('APP_NAME', TXT_A); ?></h1></span>
                        </div>
                        ...
                        <div class="pull-right">
                            ...
                            <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
                                <li class="">
                                    <a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown" style="padding-top: 3px;padding-left: 3px;"> 
                                        <!--<img src="<?php echo ASSETS_URL; ?>/img/misc/logo.png" alt="Super Admin" class="online" style="width: 57px; height: 28px;" />-->
                                        <span class="profileheader"><?php echo getLocaleText('HEADER_MSG_1', TXT_A); ?></span>
                                        <i class="fa fa-angle-down" style="vertical-align: middle;margin-top: 8px;"></i>
                                    </a>
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a href="settings.php" class="padding-10 padding-top-0 padding-bottom-0"><i class="fa fa-cog"></i> <?php echo getLocaleText('HEADER_MSG_2', TXT_A); ?></a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="help.php" class="padding-10 padding-top-0 padding-bottom-0"><i class="fa fa-question"></i> <?php echo getLocaleText('HEADER_MSG_3', TXT_A); ?></a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="javascript:void(0);" class="padding-10 padding-top-0 padding-bottom-0" data-action="launchFullscreen"><i class="fa fa-arrows-alt"></i> <?php echo getLocaleText('HEADER_MSG_4', TXT_A); ?></a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="logout.php" class="padding-10 padding-top-5 padding-bottom-5" data-action="userLogout" data-logout-title-msg="<?php echo getLocaleText('HEADER_MSG_8', TXT_A); ?>" data-logout-msg="<?php echo getLocaleText('HEADER_MSG_7', TXT_A); ?>" data-logout-cmd-yes="<?php echo getLocaleText('HEADER_MSG_9', TXT_A); ?>" data-logout-cmd-no="<?php echo getLocaleText('HEADER_MSG_10', TXT_A); ?>"><i class="fa fa-sign-out fa-lg"></i> <strong><?php echo getLocaleText('HEADER_MSG_5', TXT_A); ?></strong></a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <div id="logout" class="btn-header transparent pull-right">
                                <span> <a href="<?php echo APP_URL; ?>/logout.php" title="<?php echo getLocaleText('HEADER_MSG_6', TXT_A); ?>" data-action="userLogout" data-logout-title-msg="<?php echo getLocaleText('HEADER_MSG_8', TXT_A); ?>" data-logout-msg="<?php echo getLocaleText('HEADER_MSG_7', TXT_A); ?>" data-logout-cmd-yes="<?php echo getLocaleText('HEADER_MSG_9', TXT_A); ?>" data-logout-cmd-no="<?php echo getLocaleText('HEADER_MSG_10', TXT_A); ?>"><i class="fa fa-sign-out"></i></a> </span>
                            </div>

                            <div id="fullscreen" class="btn-header transparent pull-right">
                                <span> <a href="javascript:void(0);" title="<?php echo getLocaleText('HEADER_MSG_4', TXT_A); ?>" data-action="launchFullscreen"><i class="fa fa-arrows-alt"></i></a> </span>
                            </div>
