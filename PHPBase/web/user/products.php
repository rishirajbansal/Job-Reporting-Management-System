...
$page_title = getLocaleText('PRDS_MSG_1', TXT_U);
...
if (isset($_POST['formsubmit'])){
    ...
    if ($mode == USERDYNAFIELDS_LIST_MODE_DELETE){
        ...
        $updateFlag = $userOrgDao->deleteProduct($userOrgInputs);
    }
...
//Load data for Products list
$loadFlag = $userOrgDao->loadProductsList($userOrgInputs);
$isListLoaded = FALSE;
$totalPrds = 0;
...
if ($loadFlag){
    ...
    $tableHeadPrdDetails = $userOrgDao->getTableHeadPrdDetails();
    $tableBodyPrdDetailsEn = $userOrgDao->getTableBodyPrdDetailsEn();
    ...
    <div id="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-tags"></i> <?php echo getLocaleText('PRDS_MSG_2', TXT_U); ?> </h1>
            </div>
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                <ul id="sparks" class="">
                    <li class="sparks-info">
                        <h5> <?php echo getLocaleText('PRDS_MSG_3', TXT_U); ?> <span class="txt-color-blue" style="text-align: center"><?php echo $totalPrds; ?></span></h5>
                    </li>
                </ul>
            </div>
        </div>
        ...
        if ($loadFlag) { ?>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2><?php echo getLocaleText('PRDS_MSG_4', TXT_U); ?> </h2>
                            </header>
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <form class="form-horizontal" id="prdListForm" name="prdListForm" method="post" action="">
                                        ...
                                        if ($isListLoaded === FALSE){ ?>
                                            <div class="alert alert-warning fade in">
                                                ...
                                                <?php echo getLocaleText('PRDS_MSG_5', TXT_U); ?>
                                            </div>
                                        <?php
                                        } 
                                        ?>
                                        <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                                            ...
                                            <thead>
                                                <!--<tr>
                                                    <?php
                                                    foreach ($tableHeadPrdDetails as $key => $value){ ?>
                                                        <th class="hasinput">
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                    <th style="width:12%;"><?php echo getLocaleText('PRDS_MSG_11', TXT_U); ?></th>                                                      
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                ...
                                                if ($isListLoaded === TRUE){
                                                    foreach ($tableBodyPrdDetailsEn as $datakey => $fieldIdValue){ 
                                                        $prdId = $datakey;
                                                        ?>
                                                        <tr>
                                                            <?php
                                                            foreach ($tableHeadPrdDetails as $key1 => $value1){ ?>
                                                                <?php
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    <button class="btn bg-color-greylight txt-color-white btn-sm dropdown-toggle" data-toggle="dropdown"><?php echo getLocaleText('PRDS_MSG_BTN_1', TXT_U); ?> <span class="caret"></span></button>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a href="javascript:actionSubmit('<?php echo USERDYNAFIELDS_LIST_MODE_VIEW; ?>', <?php echo $prdId; ?>);"><?php echo getLocaleText('PRDS_MSG_BTN_2', TXT_U); ?></a></li>
                                                                        <li><a href="javascript:actionSubmit('<?php echo USERDYNAFIELDS_LIST_MODE_EDIT; ?>', <?php echo $prdId; ?>);"><?php echo getLocaleText('PRDS_MSG_BTN_3', TXT_U); ?></a></li>
                                                                        <li><a href="javascript:actionSubmit('<?php echo USERDYNAFIELDS_LIST_MODE_DELETE; ?>', <?php echo $prdId; ?>);"><?php echo getLocaleText('PRDS_MSG_BTN_4', TXT_U); ?></a></li>
                                                                    </ul>
                                                                </div>
                                                            </td>
                                                        </tr>
            ...
            <div id="deleteConf" title="">
                <br/>
                <h5><?php echo getLocaleText('PRDS_MSG_6', TXT_U); ?></h5>
                <br/>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("div.toolbar").html('<div class="text-right"><a href="javascript:actionSubmit(\'<?php echo USERDYNAFIELDS_LIST_MODE_NEW; ?>\', \'\');" class="btn btn-primary" style="margin-bottom: 6px;"><i class="fa fa-plus"></i> <span class="hidden-mobile"><?php echo getLocaleText('PRDS_MSG_7', TXT_U); ?></span></a></div>');
    ...
    $('#deleteConf').dialog({
            ...
            buttons : [{
                    html : "<i class='fa fa-trash-o'></i>&nbsp; <?php echo getLocaleText('PRDS_MSG_8', TXT_U); ?>",
                    "class" : "btn btn-danger",
                    click : function() {
                            document.getElementById('mode').value = '<?php echo USERDYNAFIELDS_LIST_MODE_DELETE; ?>';
                            document.getElementById('prdid').value = dialogPrdId;
                            document.getElementById('formsubmit').value = 'prdListForm';
                            dialogPrdId = null;
                            $("#prdListForm").submit();
                    }
            }, {
                    html : "<i class='fa fa-times'></i>&nbsp; <?php echo getLocaleText('PRDS_MSG_9', TXT_U); ?>",
            ...
            open: function(event, ui){
                    $(this).parent().find('.ui-dialog-title').append("<div class='widget-header' style='color: #FFF;'><h4><i class='fa fa-warning'></i> <?php echo getLocaleText('PRDS_MSG_10', TXT_U); ?></h4></div>");
                },
    ...
    function actionSubmit(command, prdid){
        ...
        switch (command){
            ...
            case '<?php echo USERDYNAFIELDS_LIST_MODE_NEW ?>':
                ...
                document.getElementById('formsubmit').value = 'prdListForm';
                document.forms['prdListForm'].action = 'newPrd.php';
                $("#prdListForm").submit();
                break;
            ...
            case '<?php echo USERDYNAFIELDS_LIST_MODE_VIEW ?>':
                ...
                document.getElementById('formsubmit').value = 'prdListForm';
                document.forms['prdListForm'].action = 'viewPrd.php';
                $("#prdListForm").submit();
                break;
...
<?php
    ...
    function preInputsInspection(UserOrgInputs $userOrgInputs){
        ...
        $userOrgInputs->setIdprds(mysql_real_escape_string($_POST['prdid']));
