...
$page_title = getLocaleText('NEW_WRK_MSG_1', TXT_U);
...
//Load prerequisties for Worker creation
...
if (isset($_POST['formsubmit']) && $_POST['formsubmit'] != 'wrkrListForm' && $_POST['formsubmit'] != 'viewWrkrDetailsForm'){
    ...
    $saveFlag = $userOrgDao->saveNewWorker($userOrgInputs, $mode);
...
else if (!empty($loadFlag) && isset($_POST['formsubmit']) && ($_POST['formsubmit'] == 'wrkrListForm' || $_POST['formsubmit'] == 'viewWrkrDetailsForm') && isset($_POST['mode'])){
    ...
    <div id="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-user"></i> 
                    ...
                    if ($mode == USERDYNAFIELDS_LIST_MODE_NEW){ ?>
                         <?php echo getLocaleText('NEW_WRK_MSG_2', TXT_U); ?>
                    <?php
                    } 
                    else if ($mode == USERDYNAFIELDS_LIST_MODE_EDIT){ ?>
                        <?php echo getLocaleText('NEW_WRK_MSG_3', TXT_U); ?>
                    <?php
                    }
                    ?>
                </h1>
            ...
            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                <a href="workers.php" class="btn bg-color-blueLight txt-color-white btn-lg pull-right header-btn hidden-mobile"><i class="fa fa-arrow-circle-left "></i> &nbsp;<?php echo getLocaleText('NEW_WRK_MSG_4', TXT_U); ?></a>
            </div>
        </div>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2><?php echo getLocaleText('NEW_WRK_MSG_5', TXT_U); ?> </h2>
                            </header>
                            ...
                            <div>
                                ...
                                <div class="widget-body" style="padding-left: 20px;padding-right: 20px;">
                                    ...
                                    <form class="form-horizontal" id="newWrkrForm" name="newWrkrForm" method="post" action="">
                                        ...
                                        <h3><strong><?php echo getLocaleText('NEW_WRK_MSG_6', TXT_U); ?></strong></h3>
                                        <p><?php echo getLocaleText('NEW_WRK_MSG_7', TXT_U); ?>  </p>
        ...
        <?php
            ...
            <div class="alert alert-danger fade in">
                ...
                <?php echo getLocaleText('NEW_WRK_MSG_8', TXT_U); ?>
            </div>
        <?php
        }
        ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var $validator = $("#newWrkrForm").validate({
        ...
        $('#btnSave').on('click', function () {
            ...
            if (!$valid) {
                ...
                document.forms['newWrkrForm']['formsubmit'].value = 'formsubmit';
                $("#newWrkrForm").submit();
            }
        });
        ...
        $('#btnReset').on('click', function () {
            $validator.resetForm();
            document.getElementById('newWrkrForm').reset();
        });
...
<?php
    ...
    function preInputsInspection(UserOrgInputs $userOrgInputs, UserOrgDao $userOrgDao){
        ...
        if (isset($_POST['wrkrid'])){
            $userOrgInputs->setIdwrks($_POST['wrkrid']);
        }
