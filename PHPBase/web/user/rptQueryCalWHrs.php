...
$page_title = getLocaleText('RPT_Q_CAL_W_HRS_MSG_1', TXT_U);
...
$page_nav["reporting"]["sub"]["rptQFilters"]["sub"]["qFilter2"]["active"] = true;
include("inc/nav.php");
...
if (isset($_POST['formsubmit']) && $_POST['formsubmit'] == 'rptQCalWHrsForm'){
    
    preInputsInspection($userOrgInputs);
    
    $filterFlag = $userOrgDao->findQFilterCalWHrs($userOrgInputs);
    ...
    if ($filterFlag){
        ...
        if (null != $reportQFilterResSet && !empty($reportQFilterResSet)){
            $isListLoaded = TRUE;
            if (isset($_SESSION['exportData_CalWHrs'])){
                unset($_SESSION['exportData_CalWHrs']);
            }
            $exportData->setQFilterData($reportQFilterResSet);
            $exportData->setTotalHrs($userOrgDao->getTotalServiceHrs());
            $_SESSION['exportData_CalWHrs'] = $exportData;
        }
    }
    else{
...
else if (isset($_POST['formsubmit']) && $_POST['formsubmit'] == 'rptQCalWHrsResForm'){
    ...
    if (isset($_SESSION['exportData_CalWHrs'])){
        ...
        header('location: dLoader.php?qf=calWHrs');
    }
...
<div id="main" role="main">
    ...
    <?php
        $breadcrumbs[getLocaleText('RPT_Q_CAL_W_HRS_MSG_2', TXT_U)] = "";
    ...
    <div id="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-database"></i> <?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_3', TXT_U); ?></h1>
            </div>
        </div>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2><?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_4', TXT_U); ?> </h2>
                            </header>
                            ...
                            <div>
                                ...
                                <div class="widget-body" style="padding-left: 20px;padding-right: 20px;">
                                    ...
                                    <form class="form" id="rptQCalWHrsForm" name="rptQCalWHrsForm" method="post" action="">
                                        <input type="hidden" name="formsubmit" id="formsubmit" value=""/>

                                        <h4><strong><?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_5', TXT_U); ?></strong></h4>
                                        <p><?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_6', TXT_U); ?> </p>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="alert alert-block alert-form-wizard-error" id="divErrBlock" style="display: none">
                                                <?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_24', TXT_U); ?>
                                            </div>

                                            <div class="col-md-3" style="padding-left: 0px;">
                                                <div class="input-group">
                                                    <div class="input-group-addon">
                                                        <label class="control-label control-label-filter"><strong><?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_7', TXT_U); ?></strong> </label>
                                                    </div>
                                                    
                                                    <input class="form-control" type="text" placeholder="<?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_8', TXT_U); ?>" name="sdate" id="sdate" value="<?php if (isset($userOrgInputs) && !empty($userOrgInputs->getQf_sdate())) { echo $userOrgInputs->getQf_sdate(); } ?>" >
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    <div class="input-group-addon">
                                                        <label class="control-label control-label-filter"><strong><?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_9', TXT_U); ?></strong> </label>
                                                    </div>
                                                    <input class="form-control" type="text" placeholder="<?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_10', TXT_U); ?>" name="edate" id="edate" value="<?php if (isset($userOrgInputs) && !empty($userOrgInputs->getQf_edate())) { echo $userOrgInputs->getQf_edate(); } ?>" >
                                                    <span class="input-group-addon "><i class="fa fa-calendar fa-fw"></i></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    <div class="input-group-addon">
                                                        <label class="control-label control-label-filter"><strong><?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_11', TXT_U); ?></strong> </label>
                                                    </div>
                                                    <select class="form-control" name="client" id="client">
                                                        <option value=""><?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_12', TXT_U); ?></option>
                                                        <?php
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    <div class="input-group-addon">
                                                        <label class="control-label control-label-filter"><strong><?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_13', TXT_U); ?></strong> </label>
                                                    </div>
                                                    <select class="form-control" name="worker" id="worker">
                                                        <option value=""><?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_14', TXT_U); ?></option>
                                                        <?php
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <button type="button" class="btn btn-default" id="btnClear">
                                                            <i class="fa fa-recycle"></i> <?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_BTN_1', TXT_U); ?>
                                                        </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <button type="button" class="btn btn-default" id="btnReset">
                                                            <i class="fa fa-refresh"></i> <?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_BTN_2', TXT_U); ?>
                                                        </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <button type="button" class="btn btn-primary" id="btnSearch">
                                                            <i class="fa fa-search"></i> <?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_BTN_3', TXT_U); ?>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="jarviswidget jarviswidget-color-purple" id="wid-id-1" 
                                ...
                                <header>
                                    ...
                                    <h2><?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_15', TXT_U); ?> </h2>
                                </header>
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <form class="form-horizontal" id="rptQCalWHrsResForm" name="rptQCalWHrsResForm" method="post" action="">
                                            <input type="hidden" name="formsubmit" id="formsubmit" value=""/>
                                            ...
                                            if ($isListLoaded === FALSE){ ?>
                                                <div class="alert alert-warning fade in">
                                                    ...
                                                    <?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_16', TXT_U); ?>
                                                </div>
                                            <?php
                                            } 
                                            ?>
                                            <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr>
                                                        <th data-class="expand" style="width:10%"><?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_17', TXT_U); ?></th>
                                                        <th data-hide="phone,tablet" style="width:15%"><?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_18', TXT_U); ?></th>
                                                        <th style="width:35%"><?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_19', TXT_U); ?></th>
                                                    </tr>
                                                    ...
                                                    if ($isListLoaded === TRUE){
                                                        foreach ($reportQFilterResSet as $reportQFilterRes){ ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding-top: 14px;"><?php echo $reportQFilterRes->getServiceHrs(); ?></td>
                                                            </tr>
                                                        ...
                                                        <tr class="warning  text-primary">
                                                            <td style="padding-top: 14px;border-right: 0px;" ></td>
                                                            <td style="padding-top: 14px;text-align: right" ><strong><?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_20', TXT_U); ?></strong></td>
                                                            <td style="padding-top: 14px;"><strong><?php echo $userOrgDao->getTotalServiceHrs(); ?></strong></td>
                                                        </tr>
                                                    <?php
                                                    }
                                                    ?>
        ...
        <?php
            ...
            <div class="alert alert-danger fade in">
                ...
                <?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_21', TXT_U); ?>
            </div>
        <?php
        }
        ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var $validator = $("#rptQCalWHrsForm").validate({
        ...
        $('#btnSearch').on('click', function () {
            var $valid = $("#rptQCalWHrsForm").valid();
            if (!$valid) {
                $validator.focusInvalid();
                return false;
            }
            else if (document.forms['rptQCalWHrsForm']['sdate'].value == '' && 
                    document.forms['rptQCalWHrsForm']['edate'].value == '' && 
                    document.forms['rptQCalWHrsForm']['client'].value == '' && 
                    document.forms['rptQCalWHrsForm']['worker'].value == ''){
                
                document.getElementById('divErrBlock').style.display = 'block';
            }
            else{
                document.forms['rptQCalWHrsForm']['formsubmit'].value = 'rptQCalWHrsForm';
                $("#rptQCalWHrsForm").submit();
            }
        });
        
        $('#btnReset').on('click', function () {
            $validator.resetForm();
            document.getElementById('rptQCalWHrsForm').reset();
        });
    ...
    function exportRpt(type){
        ...
        $.smallBox({
            title: "<?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_22', TXT_U); ?>",
            content: "<?php echo getLocaleText('RPT_Q_CAL_W_HRS_MSG_23', TXT_U); ?>",
            color: "#296191",
            iconSmall: "fa fa-check bounce animated",
            timeout: 10000
        });
        
        document.forms['rptQCalWHrsResForm']['exportType'].value = type;
        document.forms['rptQCalWHrsResForm']['formsubmit'].value = 'rptQCalWHrsResForm';
        $("#rptQCalWHrsResForm").submit();
