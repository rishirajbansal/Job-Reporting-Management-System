...
$page_title = getLocaleText('NEW_TSK_MSG_1', TXT_U);
...
//Load prerequisties for Task creation
...
if (isset($_POST['formsubmit']) && $_POST['formsubmit'] != 'tskListForm' && $_POST['formsubmit'] != 'viewTskDetailsForm'){
    ...
    $saveFlag = $userOrgDao->saveNewTask($userOrgInputs, $mode);
...
else if (!empty($loadFlag) && isset($_POST['formsubmit']) && ($_POST['formsubmit'] == 'tskListForm' || $_POST['formsubmit'] == 'viewTskDetailsForm') && isset($_POST['mode'])){
    ...
    <div id="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-list-alt"></i> 
                    ...
                    if ($mode == USERDYNAFIELDS_LIST_MODE_NEW){ ?>
                         <?php echo getLocaleText('NEW_TSK_MSG_2', TXT_U); ?>
                    <?php
                    } 
                    else if ($mode == USERDYNAFIELDS_LIST_MODE_EDIT){ ?>
                        <?php echo getLocaleText('NEW_TSK_MSG_3', TXT_U); ?>
                    <?php
                    }
                    ?>
                </h1>
            ...
            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                <a href="tasks.php" class="btn bg-color-blueLight txt-color-white btn-lg pull-right header-btn hidden-mobile"><i class="fa fa-arrow-circle-left "></i> &nbsp;<?php echo getLocaleText('NEW_TSK_MSG_4', TXT_U); ?></a>
            </div>
        </div>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2><?php echo getLocaleText('NEW_TSK_MSG_5', TXT_U); ?> </h2>
                            </header>
                            ...
                            <div>
                                ...
                                <div class="widget-body" style="padding-left: 20px;padding-right: 20px;">
                                    ...
                                    <form class="form-horizontal" id="newTskForm" name="newTskForm" method="post" action="">
                                        ...
                                        <h3><strong><?php echo getLocaleText('NEW_TSK_MSG_6', TXT_U); ?></strong></h3>
                                        <p><?php echo getLocaleText('NEW_TSK_MSG_7', TXT_U); ?>  </p>
        ...
        <?php
            ...
            <div class="alert alert-danger fade in">
                ...
                <?php echo getLocaleText('NEW_TSK_MSG_8', TXT_U); ?>
            </div>
        <?php
        }
        ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var $validator = $("#newTskForm").validate({
        ...
        $('#btnSave').on('click', function () {
            ...
            if (!$valid) {
                ...
                document.forms['newTskForm']['formsubmit'].value = 'formsubmit';
                $("#newTskForm").submit();
            }
        });
        ...
        $('#btnReset').on('click', function () {
            $validator.resetForm();
            document.getElementById('newTskForm').reset();
        });
...
<?php
    ...
    function preInputsInspection(UserOrgInputs $userOrgInputs, UserOrgDao $userOrgDao){
        ...
        if (isset($_POST['tskid'])){
            $userOrgInputs->setIdtsks($_POST['tskid']);
        }
