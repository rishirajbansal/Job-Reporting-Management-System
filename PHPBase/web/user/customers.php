...
$page_title = getLocaleText('CUSTOMERS_MSG_1', TXT_U);
...
if (isset($_POST['formsubmit'])){
    ...
    if ($mode == USERDYNAFIELDS_LIST_MODE_DELETE){
        ...
        $updateFlag = $userOrgDao->deleteCustomer($userOrgInputs);
    }
...
//Load data for Customers list
$loadFlag = $userOrgDao->loadCustomersList($userOrgInputs);
$isListLoaded = FALSE;
$totalCstmrs = 0;
...
if ($loadFlag){
    ...
    $tableHeadCstmrDetails = $userOrgDao->getTableHeadCstmrDetails();
    $tableBodyCstmrDetailsEn = $userOrgDao->getTableBodyCstmrDetailsEn();
    ...
    <div id="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-building"></i><?php echo getLocaleText('CUSTOMERS_MSG_2', TXT_U); ?>  </h1>
            </div>
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                <ul id="sparks" class="">
                    <li class="sparks-info">
                        <h5> <?php echo getLocaleText('CUSTOMERS_MSG_3', TXT_U); ?> <span class="txt-color-blue" style="text-align: center"><?php echo $totalCstmrs; ?></span></h5>
                    </li>
                </ul>
            </div>
        </div>
        ...
        if ($loadFlag) { ?>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2><?php echo getLocaleText('CUSTOMERS_MSG_4', TXT_U); ?> </h2>
                            </header>
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <form class="form-horizontal" id="cstmrListForm" name="cstmrListForm" method="post" action="">
                                        ...
                                        if ($isListLoaded === FALSE){ ?>
                                            <div class="alert alert-warning fade in">
                                                ...
                                                <?php echo getLocaleText('CUSTOMERS_MSG_5', TXT_U); ?>
                                            </div>
                                        <?php
                                        } 
                                        ?>
                                        <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                                            ...
                                            <thead>
                                                <!--<tr>
                                                    <?php
                                                    foreach ($tableHeadCstmrDetails as $key => $value){ ?>
                                                        <th class="hasinput">
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                    <th style="width:12%;"><?php echo getLocaleText('CUSTOMERS_MSG_6', TXT_U); ?></th>                                                    
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                ...
                                                if ($isListLoaded === TRUE){
                                                    foreach ($tableBodyCstmrDetailsEn as $datakey => $fieldIdValue){ 
                                                        $cstmrId = $datakey;
                                                        ?>
                                                        <tr>
                                                            <?php
                                                            foreach ($tableHeadCstmrDetails as $key1 => $value1){ ?>
                                                                <?php
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    <button class="btn bg-color-greylight txt-color-white btn-sm dropdown-toggle" data-toggle="dropdown"><?php echo getLocaleText('CUSTOMERS_MSG_BTN_1', TXT_U); ?> <span class="caret"></span></button>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a href="javascript:actionSubmit('<?php echo USERDYNAFIELDS_LIST_MODE_VIEW; ?>', <?php echo $cstmrId; ?>);"><?php echo getLocaleText('CUSTOMERS_MSG_BTN_2', TXT_U); ?></a></li>
                                                                        <li><a href="javascript:actionSubmit('<?php echo USERDYNAFIELDS_LIST_MODE_EDIT; ?>', <?php echo $cstmrId; ?>);"><?php echo getLocaleText('CUSTOMERS_MSG_BTN_3', TXT_U); ?></a></li>
                                                                        <li><a href="javascript:actionSubmit('<?php echo USERDYNAFIELDS_LIST_MODE_DELETE; ?>', <?php echo $cstmrId; ?>);"><?php echo getLocaleText('CUSTOMERS_MSG_BTN_4', TXT_U); ?></a></li>
                                                                    </ul>
                                                                </div>
                                                            </td>
                                                        </tr>
            ...
            <div id="deleteConf" title="">
                <br/>
                <h5><?php echo getLocaleText('CUSTOMERS_MSG_7', TXT_U); ?></h5>
                <br/>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("div.toolbar").html('<div class="text-right"><a href="javascript:actionSubmit(\'<?php echo USERDYNAFIELDS_LIST_MODE_NEW; ?>\', \'\');" class="btn btn-primary" style="margin-bottom: 6px;"><i class="fa fa-plus"></i> <span class="hidden-mobile"><?php echo getLocaleText('CUSTOMERS_MSG_8', TXT_U); ?></span></a></div>');
    ...
    $('#deleteConf').dialog({
            ...
            buttons : [{
                    html : "<i class='fa fa-trash-o'></i>&nbsp; <?php echo getLocaleText('CUSTOMERS_MSG_9', TXT_U); ?>",
                    "class" : "btn btn-danger",
                    click : function() {
                            document.getElementById('mode').value = '<?php echo USERDYNAFIELDS_LIST_MODE_DELETE; ?>';
                            document.getElementById('cstmrid').value = dialogCstmrId;
                            document.getElementById('formsubmit').value = 'cstmrListForm';
                            dialogCstmrId = null;
                            $("#cstmrListForm").submit();
                    }
            }, {
                    html : "<i class='fa fa-times'></i>&nbsp; <?php echo getLocaleText('CUSTOMERS_MSG_10', TXT_U); ?>",
            ...
            open: function(event, ui){
                    $(this).parent().find('.ui-dialog-title').append("<div class='widget-header' style='color: #FFF;'><h4><i class='fa fa-warning'></i> <?php echo getLocaleText('CUSTOMERS_MSG_11', TXT_U); ?></h4></div>");
                },
    ...
    function actionSubmit(command, cstmrid){
        ...
        switch (command){
            ...
            case '<?php echo USERDYNAFIELDS_LIST_MODE_NEW ?>':
                ...
                document.getElementById('formsubmit').value = 'cstmrListForm';
                document.forms['cstmrListForm'].action = 'newCstmr.php';
                $("#cstmrListForm").submit();
                break;
            
            case '<?php echo USERDYNAFIELDS_LIST_MODE_VIEW ?>':
                document.getElementById('mode').value = '<?php echo USERDYNAFIELDS_LIST_MODE_VIEW; ?>';
                document.getElementById('cstmrid').value = cstmrid;
                document.getElementById('formsubmit').value = 'cstmrListForm';
                document.forms['cstmrListForm'].action = 'viewCstmr.php';
                $("#cstmrListForm").submit();
                break;
...
<?php
    ...
    function preInputsInspection(UserOrgInputs $userOrgInputs){
        ...
        $userOrgInputs->setIdcstmrs(mysql_real_escape_string($_POST['cstmrid']));
