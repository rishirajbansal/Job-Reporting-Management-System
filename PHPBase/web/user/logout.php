...
$page_title = getLocaleText('LOGOUT_MSG_1', TXT_U);
...
if (!empty($_SESSION['loggedIn']) && ($_SESSION['loggedIn'] == 1) && !empty($_SESSION['orgid'])) {
    ...
    unset($_SESSION['logo']);
    unset($_SESSION['queryFilter']);
    unset($_SESSION['allQueryFilter']);*/
...
<header id="header">
    <div id="apptitle" class="txt-color-red login-header-big" style="margin-left: 10px;margin-top: 15px;width: auto;">
        <span><h1 style="color: #1f629d;"><strong><?php echo getLocaleText('LOGOUT_MSG_2', TXT_U); ?></strong></h1></span>
    </div>
</header>
                ...
                <div class="col-md-6 col-md-offset-3">
                            ...
                            <div class="col-sm-12 ">
                                ...
                                if (isset($_GET['st'])){ ?>
                                    <div class="alert alert-warning alert-block">
                                        <br/>
                                        <h4 class="alert-heading"><?php echo getLocaleText('LOGOUT_MSG_4', TXT_U); ?></h4>
                                        <br/>
                                        <h5 style="font-weight: 400;"><?php echo getLocaleText('LOGOUT_MSG_5-1', TXT_U); ?> <span class="txt-color-red"><?php echo $userSessionTimeout; ?> <?php echo getLocaleText('LOGOUT_MSG_5-2', TXT_U); ?></span></h5>
                                        <br/>
                                    </div>
                                <?php
                                }
                                    ...
                                    <div class="alert alert-info alert-block">
                                        <br/>
                                        <h4 class="alert-heading"><?php echo getLocaleText('LOGOUT_MSG_6', TXT_U); ?></h4> 
                                        <br/>
                                    </div>
                                    <br/>
                                    <h1 class="txt-color-red login-header-big text-center"><?php echo getLocaleText('LOGOUT_MSG_7', TXT_U); ?></h1>
                                <?php
                                }
                                ?>
                                <br/>
                    ...
                    <div class="text-center">
                        <button type="button" class="btn btn-primary btn-lg" id="btnSubmit" style="font-weight: 400;" onclick="javascript:location.href='login.php'">
                            <i class="fa fa-arrow-circle-right fa-fw"></i> <?php echo getLocaleText('LOGOUT_MSG_BTN_1', TXT_U); ?>
                        </button>
                    </div>
